...
\textit{Nota: Si bien los valores válidos dentro de los parámetros no contienen  caracteres especiales del español ('´','ñ'), los documentos en inglés si los tienen}.
